...
(function() {
  ...
  //declare controller
  angular.module("BlurAdmin.pages.myPage").controller("myListCtrl", myListCtrl);
  ...
  function myListCtrl($scope, $state) {
    ...
    $scope.editData2 = function(itemID) {
      sessionStorage.itemID = itemID;
      location.href = "#/myCheck";
    };
    // $scope.editData2 = function(itemID) {
    //     sessionStorage.itemID = itemID;
    ...
    $scope.deleteData = function(itemID) {
      var deleteRow = $scope.sessionStorage[itemID];
